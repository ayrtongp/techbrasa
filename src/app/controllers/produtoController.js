...
class ComposicaoController {
  ...
  async list(req, res) {
    ...
    return res.json({
      count: todosProdutos.count,
      rows: todosProdutos.rows,
      method: {
        type: 'GET',
        url: `${url}/produtos`,
      }
  ...
  async update(req, res) {
    const { idProduto } = req.params
    const { nomeProduto, categoria, precoVenda, descricao, mostraProduto, idFranqueado, updatedAt } = req.query
    ...
    mostraProduto != "" ? loopObject['mostra_produto'] = mostraProduto : null
